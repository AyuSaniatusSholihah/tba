...
dfa_testing.py
==============
Fitur 1: Input DFA + Uji String dengan Animasi Glow pada State Aktif
"""
...
def render():
    ...
    st.caption("Masukkan definisi DFA, lalu uji string dengan animasi glow state-by-state.")
    ...
    if 'dfa_1' in st.session_state:
        ...
        # Tampilkan graf awal (idle) - highlight start state
        ...
        run_btn = st.button("▶️ Jalankan", key="dfa1_run", use_container_width=True)
